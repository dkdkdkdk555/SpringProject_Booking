...
<div style="margin:auto; height:605px; width:525px;" >
	<div id="logo">
		<a href="../home.do">
	...
	<!-- 
	 ...
	 <form action="${pageContext.request.contextPath }/users/signup.do" method="post" id="myForm" novalidate>
	 	...
	 	<div id="btn">
	 		<button class="btn-primary" type="submit" style="width:525px; height:48px;
	 		 background-color:#0f4c81; border-color:#0f4c81">가입</button>
	 	</div>
	 </form>
</div>
<script>
